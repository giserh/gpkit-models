...
class DAPCA4Cost(Model):
    ...
    def setup(self, eng_defined=False):
        ...
        # Cost Varibles
        C_Dv = Var("C_Dv", "USD2012", "Development Cost")
        ...
        C_Dv_const = Var("C_{Dv_const}", 91.3,
                        units.USD2012/(units.lbf**0.630 * units.knots**1.3),
                        "C_Dv power law proportionality constant")
        ...
        objective = C_fly
        constraints = [C_fly >= (H_E*R_E + H_T*R_T + H_M*R_M + H_Q*R_Q + C_Dv +
                       ...
                       H_Q >= H_Q_const  *H_E,
                       C_Dv >= C_Dv_const * W_e**0.630 * V**1.3,
